...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { booking_id: @passenger.booking_id, email: @passenger.email, name: @passenger.name } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { booking_id: @passenger.booking_id, email: @passenger.email, name: @passenger.name } }
