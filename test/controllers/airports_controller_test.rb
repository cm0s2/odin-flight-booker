...
class AirportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airport" do
    assert_difference("Airport.count") do
      post airports_url, params: { airport: { iata_code: @airport.iata_code, name: @airport.name } }
    end
  ...
  test "should update airport" do
    patch airport_url(@airport), params: { airport: { iata_code: @airport.iata_code, name: @airport.name } }
